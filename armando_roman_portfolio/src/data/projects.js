...
export const projects = [
  ...
  },
  {
    ...
    projectDescription: `A web app that gives you recipes with ingredients that you have on hand. In order to build Quarantine Cook, I had to grab and persist the users' ingredients and make HTTP requests to a third party API holding information on over 65,000 recipes across many sites.`,
    techStack: ["ReactJS", "Axios", "SCSS"],
