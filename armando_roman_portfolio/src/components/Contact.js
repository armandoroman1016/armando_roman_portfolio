                ...
                <form id="contact_form" onSubmit={handleSubmit}>
                    <div className="input-container">
                        <div className="name">
                            ...
                            <input
                                ...
                                style={
                                    submitted && !values.name
                                        ? {
                                              border: "1.2px solid #ff5252",
                                              boxShadow: "0 0 3px #ff5252",
                                          }
                                        : null
                                }
                            />
                        ...
                        <div className="phone">
                            <label>
                                PHONE
                                {submitted && !values.phone && !values.email ? (
                                    <p>*Phone or Email Required</p>
                                ) : null}
                            </label>
                            <input
                                type="tel"
                    ...
                    <div className="button_message">
                        ...
                        <div className="social">
                            <a
                                href="https://www.linkedin.com/in/armando-roman/"
                                className="link"
                            >
                                <img src={linked} alt="linked in logo" />
                            </a>
                            <a
                                href="mailto:armandoroman1016@gmail.com"
                                target="_top"
                                className="link"
                            >
                            ...
                            <a
                                href="https://github.com/armandoroman1016"
                                className="link"
                            >
